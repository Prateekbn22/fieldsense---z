...
#define FAULT_INJECTION_NORMAL_ENVIRONMENT BIT(5)
...
#define FAULT_INJECTION_ALL_MASK \
	(FAULT_INJECTION_SENSOR_READ_FAILURE | \
	 ...
	 FAULT_INJECTION_NORMAL_ENVIRONMENT)
...
#define FAULT_INJECTION_NORMAL_TEMP_MILLI_C 26000
#define FAULT_INJECTION_NORMAL_PRESSURE_PA 100000
